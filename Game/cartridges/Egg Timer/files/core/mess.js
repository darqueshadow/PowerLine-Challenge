  ...
  ET.mess = {
    ...
    splatter: function (canvas, count, anywhere) {
      ...
      for (var i = 0; i < count; i++) {
        ...
        // one irregular splotch: uneven radii joined with curves (a blob, not a star),
        // squashed a little flat
        var lobes = 9, pts = [];

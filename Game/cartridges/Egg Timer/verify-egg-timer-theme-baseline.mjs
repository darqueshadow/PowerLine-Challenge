/* verify-egg-timer-theme-baseline.mjs: section T's record of every rule of the game's stylesheets, resolved
   to final values. Written by `node verify-egg-timer.mjs --write-theme-baseline` on 2026-09-23.
...
export default {
 ...
 "#warp.lit": {
  ...
  "background-clip": "initial",
  "background-color": "initial",
  "background-image": "radial-gradient(rgb(61, 255, 154), rgb(14, 143, 76) 80%)",
  "background-origin": "initial",
  "background-position-x": "initial",
  "background-position-y": "initial",
  "background-repeat": "initial",
  ...
  "box-shadow": "rgb(0, 0, 0) 5px 5px 0px, rgba(61, 255, 154, 0.55) 0px 0px 22px 4px",
  "color": "rgb(4, 23, 12)",
  "text-shadow": "rgb(214, 255, 232) 0px 0px 6px"
 },
 "@keyframes warp » 33%": {
 ...
 ".wallclock": {
  ...
  "border-image-source": "none",
  "border-image-width": "1",
  "border-left-color": "rgb(255, 176, 0)",
  "border-left-style": "solid",
  "border-left-width": "4px",
  "border-right-color": "rgb(255, 176, 0)",
  "border-right-style": "solid",
  "border-right-width": "4px",
  "border-top-color": "rgb(255, 176, 0)",
  "border-top-style": "solid",
  "border-top-width": "4px",
  ...
  "padding-right": "14px",
  "padding-top": "2px",
  "text-shadow": "rgb(255, 176, 0) 0px 0px 0px, rgb(90, 42, 0) 2px 2px 0px",
  "text-wrap-mode": "nowrap",
  "white-space-collapse": "collapse"
 },
 "#wall-ss": {
 ...
 ".drop": {
  ...
  "background-attachment": "initial",
  "background-clip": "initial",
  "background-color": "rgb(111, 211, 255)",
  "background-image": "initial",
  "background-origin": "initial",
  "background-position-x": "initial",
  "background-position-y": "initial",
 ...
 "@keyframes drop » 100%": {
  "opacity": "0",
  "transform": "RAW translate(<--dx>, 26px)"
 },
 "#hose-tag": {
  "align-items": "center",
  "background-attachment": "initial",
 ...
 ".postit.at-clock": {
  ...
  "padding-right": "6px",
  "padding-top": "2px",
  "text-shadow": "rgb(90, 42, 0) 1px 1px 0px",
  "transform": "none"
 },
